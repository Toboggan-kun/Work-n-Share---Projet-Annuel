...
(1, 'jean', 'dupont', 'jdupont@gmail.com', '', 0, 0, NULL, 0),
(2, 'marie', 'lala', 'malal@gmail.com', '', 2, 0, NULL, 0),
(3, 'Paul', 'Lele', 'plele@live.fr', '', 2, 0, NULL, 0),
(4, 'Bonjour', 'test', 'test@gmail.fr', 'caca', 0, 0, NULL, 0);
...
--
ALTER TABLE `room`
  MODIFY `idRoom` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=73;
--
