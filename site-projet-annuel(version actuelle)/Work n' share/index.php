...
<body class="home">
		...
		<div class="container">
			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav pull-right">
					...
					<li class="dropdown">
						<a href="#" class="dropdown-togglae" data-toggle="dropdown">Nos espaces de travail<b class="caret"></b></a>
	...
	<header id="head">
		<div class="container">
			<div class="row">
				...
				<p class="tagline">Vous allez venir pour le prix, revenir pour la qualité.</p>
			</div>
		</div>
	</header>
	<!-- /Header -->
	...
	<footer id="footer" class="top-space">
		...
		<?php //include("../messagerie/index.html"); ?>
		<?php //include("../messagerie/css/app.css"); ?>
		<?php //include("../messagerie/handler.php"); ?>
		<?php //include("../messagerie/js/app.js"); ?>
	</footer>	
