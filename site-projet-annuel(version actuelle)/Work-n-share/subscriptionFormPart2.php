	...
	<div class="panel panel-primary">
		...
		<?php
			if($_POST['sub'] == "Abonnement simple" || $_POST['sub'] == "Abonnement résident"){
				...
				echo '<button type="button" id="noengagementChoice" onclick="changeStateSubscription(\'noengagementChoice\')" class="btn btn-success btn-md">Je choisis cette offre !</button></div>';
			}
		...
		<?php
			if($_POST['sub'] == "Abonnement simple" || $_POST['sub'] == "Abonnement résident"){
				...
				echo '<button type="button" id="engagementChoice" onclick="changeStateSubscription(\'engagementChoice\')" class="btn btn-success btn-md">Je choisis cette offre !</button>
				</div>';
			}
