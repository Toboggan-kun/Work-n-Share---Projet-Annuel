...
<head>
	...
	<title>Contact us - Work n' sharess</title>
	...
	<div class="container">
		...
		<div class="row">
			...
			<article class="col-sm-9 maincontent">
				...
				<p>
					Nous adorerions lire ce que vous voulez bien nous envoyer. Envie de travailler avec nous sur un projet commun? N'hésitez pas à nous expliquer plus amplement le projet ci-dessous.
					--
					Un problème? Veuillez nous le décrire avec le plus de précision possible afin que nous puissions vous répondre le plus rapidement possible.
				</p>
				<br>
					<form>
						<div class="row">
					...
					<div class="col-md-6 widget">
						<div class="widget-body">
							<p class="simplenav">
								...
								<b><a href="signup.html">S'incrire</a></b>
							</p>
						</div>
					</div>
